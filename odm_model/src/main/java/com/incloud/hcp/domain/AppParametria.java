...
public class AppParametria extends BaseDomain implements Identifiable<Long>, Serializable {
    ...
    @Override
    @Column(name = "PARAMETRIA_ID", precision = 19)
    ...
    public AppParametria id(Long id) {
        setId(id);
        return this;
    }
