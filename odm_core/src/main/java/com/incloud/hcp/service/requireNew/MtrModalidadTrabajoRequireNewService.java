...
/**
 * Simple Interface for MtrModalidadTrabajo para Carga Masiva.
 */
public interface MtrModalidadTrabajoRequireNewService extends JPACustomRequiredNewService<MtrModalidadTrabajo> {
