...
public class CertificadoNotificacion extends NotificarMail {
    ...
    private final String TEMPLATE = "webapps/odmcopeincabackend/WEB-INF/classes/templates/TemplateCertificadoNotificacion.html";
    private final String ASUNTO = "IProvider - Nota de Pedido";
    //fdfd
    private final String TEMPLATELIBERACION = "webapps/odmcopeincabackend/WEB-INF/classes/templates/TemplateLiberacion.html";
