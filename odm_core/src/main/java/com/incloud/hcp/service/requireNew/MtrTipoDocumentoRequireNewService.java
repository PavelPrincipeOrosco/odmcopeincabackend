...
/**
 * Simple Interface for MtrTipoDocumento para Carga Masiva.
 */
public interface MtrTipoDocumentoRequireNewService extends JPACustomRequiredNewService<MtrTipoDocumento> {
