...
public abstract class AppParametriaServiceImpl extends JPACustomServiceImpl<AppParametriaResponse, AppParametria, Long> implements AppParametriaService {
    ...
    protected AppParametria setUploadExcel(Cell currentCell, AppParametria appParametria, int contador) throws Exception {
        ...
        case 4:
            try {
                ...
                if (valorCadena.length() > 255) {
                    throw new ServiceException("Valor Campo status contiene mas de 255 caracter(es)");
                }
        ...
        case 7:
            try {
                valorCadena = currentCell.getStringCellValue();
                if (valorCadena.length() > 255) {
                    throw new ServiceException("Valor Campo value3 contiene mas de 255 caracter(es)");
                }
    ...
    protected final Long setObtenerId(AppParametria bean) {
        return bean.getId();
    }
