...
import com.incloud.hcp.repository.delta.CsOrdenServicioActividadDeltaRepository;
import com.incloud.hcp.repository.delta.CsOrdenServicioDeltaRepository;
import com.incloud.hcp.service.CsOrdenServicioActividadService;
...
import com.incloud.hcp.service.requireNew.CsOrdenServicioActividadRequireNewService;
...
public abstract class CsOrdenServicioActividadServiceImpl extends JPACustomServiceImpl<CsOrdenServicioActividadResponse, CsOrdenServicioActividad, Long>
        implements CsOrdenServicioActividadService {

    protected final String NAME_SHEET = "CsOrdenServicioActividad";
    protected final String CONFIG_TITLE = "com/incloud/hcp/excel/CsOrdenServicioActividadExcel.xml";
    ...
    @Autowired
    protected CsOrdenServicioActividadDeltaRepository csOrdenServicioActividadDeltaRepository;

    @Autowired
    protected CsOrdenServicioActividadRequireNewService csOrdenServicioActividadRequireNewService;
    ...
    protected abstract Sort setFind(CsOrdenServicioActividad req, ExampleMatcher matcher, Example<CsOrdenServicioActividad> example, Sort sort);

    protected abstract void setFindPaginated(PageRequestByExample<CsOrdenServicioActividad> req, ExampleMatcher matcher,
            Example<CsOrdenServicioActividad> example);

    protected final CsOrdenServicioActividad setObtenerBeanResponse(CsOrdenServicioActividadResponse bean) {
        return bean.getBean();
    }

    protected final Class<CsOrdenServicioActividad> setObtenerClassBean() {
        return CsOrdenServicioActividad.class;
    }

    protected List<Predicate> setAbstractPredicate(CsOrdenServicioActividadResponse bean, CriteriaBuilder cb, Root<CsOrdenServicioActividad> root) {
    ...
    protected final String validacionesPrevias(CsOrdenServicioActividad bean) throws Exception {
        String mensaje = "";
        if (!Optional.of(bean.getDescripcion()).isPresent()) {
            String msg = this.messageSource.getMessage("message.csOrdenServicioActividad.descripcion.requerido", null, LocaleContextHolder.getLocale());
            mensaje += "* " + msg + "<br/>";
        }
    ...
    protected String validacionesPreviasCreate(CsOrdenServicioActividad bean) throws Exception {
        String msg = null;
        CsOrdenServicioActividad validar = null;
        return msg;
    }

    protected String validacionesPreviasSave(CsOrdenServicioActividad bean) throws Exception {
        String msg = null;
        CsOrdenServicioActividad validar = null;
        return msg;
    }

    protected CsOrdenServicioActividad completarDatosBean(CsOrdenServicioActividad bean) throws Exception {
        BigDecimal data = new BigDecimal(0.00);
        bean = this.setCompletarDatosBean(bean);
        return bean;
    }

    protected CsOrdenServicioActividad setCompletarDatosBean(CsOrdenServicioActividad bean) throws Exception {
        return bean;
    }

    protected final CsOrdenServicioActividad setAbstractCreate(CsOrdenServicioActividad dto) throws Exception {
        CsOrdenServicioActividad bean = new CsOrdenServicioActividad();
        bean = (CsOrdenServicioActividad) BeanUtils.cloneBean(dto);
        return bean;
    }
    ...
    protected CsOrdenServicioActividad setUploadExcel(Cell currentCell, CsOrdenServicioActividad csOrdenServicioActividad, int contador) throws Exception {
        ...
        case 1:
            try {
                ...
                csOrdenServicioActividad.setDescripcion(valorCadena);
            } catch (Exception e) {
    ...
    protected CsOrdenServicioActividad setInicializarBeanUpdateExcel() {
        CsOrdenServicioActividad bean = new CsOrdenServicioActividad();
        bean.setId(null);
        return bean;
    }

    protected final Long setObtenerId(CsOrdenServicioActividad bean) {
        return bean.getId();
    }
    ...
    protected final CsOrdenServicioActividad createInstance() {
        CsOrdenServicioActividad csOrdenServicioActividad = new CsOrdenServicioActividad();
        return csOrdenServicioActividad;
    }

    protected final BeanCargaMasivoDTO<CsOrdenServicioActividad> createInstanceMasivoDTO() {
        BeanCargaMasivoDTO<CsOrdenServicioActividad> beanCargaMasivoDTO = new BeanCargaMasivoDTO<CsOrdenServicioActividad>();
        return beanCargaMasivoDTO;

    }

    protected final BeanListaMasivoDTO<BeanCargaMasivoDTO<CsOrdenServicioActividad>> createInstanceListaMasivoDTO() {
        BeanListaMasivoDTO<BeanCargaMasivoDTO<CsOrdenServicioActividad>> beanCargaMasivoDTOBeanListaMasivoDTO = new BeanListaMasivoDTO<BeanCargaMasivoDTO<CsOrdenServicioActividad>>();
    ...
    protected int setAbstractDownloadExcel(CsOrdenServicioActividad bean, HSSFRow dataRow) {
        int contador = 0;
    ...
    protected int setAbstractDownloadExcelSXLSX(CsOrdenServicioActividad bean, Row dataRow, List<CellStyle> cellStyleList) {
        int contador = 0;
    ...
    protected String setAbstractGenerateInsertExcelSXLSX(CsOrdenServicioActividad bean) {
        String fechaS = "";
        String sqlInsert = "INSERT INTO CS_ORDEN_SERVICIO_ACTIVIDAD(";
        sqlInsert = sqlInsert + "CS_ORDEN_SERVICIO_ACTIVIDAD_ID" + ", ";
    ...
    public Long countByCsOrdenServicio(CsOrdenServicio csOrdenServicio) {
        return this.csOrdenServicioActividadDeltaRepository.countByCsOrdenServicio(csOrdenServicio);
    }
    ...
    public GraphBean graphByCsOrdenServicio() {
        ...
        for (CsOrdenServicio bean : lista) {
            Long valor = this.csOrdenServicioActividadDeltaRepository.countByCsOrdenServicio(bean);
