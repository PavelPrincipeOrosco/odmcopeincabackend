...
/**
 * Simple Interface for CsOrdenServicio para Carga Masiva.
 */
public interface CsOrdenServicioRequireNewService extends JPACustomRequiredNewService<CsOrdenServicio> {
