...
import com.incloud.hcp.domain.MtrTipoDocumento_;
...
import com.incloud.hcp.service.requireNew.MtrTipoDocumentoRequireNewService;
...
public abstract class MtrTipoDocumentoServiceImpl extends JPACustomServiceImpl<MtrTipoDocumentoResponse, MtrTipoDocumento, Long>
        implements MtrTipoDocumentoService {

    protected final String NAME_SHEET = "MtrTipoDocumento";
    protected final String CONFIG_TITLE = "com/incloud/hcp/excel/MtrTipoDocumentoExcel.xml";
    ...
    @Autowired
    protected MtrTipoDocumentoRequireNewService mtrTipoDocumentoRequireNewService;
    ...
    protected final ExampleMatcher setAbstractFind(ExampleMatcher matcher) {
        matcher = ExampleMatcher.matching() //
                .withMatcher(MtrTipoDocumento_.descripcion.getName(), match -> match.ignoreCase().startsWith())
                .withMatcher(MtrTipoDocumento_.status.getName(), match -> match.ignoreCase().startsWith());
        return matcher;
    }

    protected abstract Sort setFindAll(Sort sort);

    protected abstract Sort setFind(MtrTipoDocumento req, ExampleMatcher matcher, Example<MtrTipoDocumento> example, Sort sort);

    protected abstract void setFindPaginated(PageRequestByExample<MtrTipoDocumento> req, ExampleMatcher matcher, Example<MtrTipoDocumento> example);

    protected final MtrTipoDocumento setObtenerBeanResponse(MtrTipoDocumentoResponse bean) {
        return bean.getBean();
    }

    protected final Class<MtrTipoDocumento> setObtenerClassBean() {
        return MtrTipoDocumento.class;
    }

    protected List<Predicate> setAbstractPredicate(MtrTipoDocumentoResponse bean, CriteriaBuilder cb, Root<MtrTipoDocumento> root) {
    ...
    protected final String validacionesPrevias(MtrTipoDocumento bean) throws Exception {
        String mensaje = "";
        if (!Optional.of(bean.getDescripcion()).isPresent()) {
            String msg = this.messageSource.getMessage("message.mtrTipoDocumento.descripcion.requerido", null, LocaleContextHolder.getLocale());
            mensaje += "* " + msg + "<br/>";
        }
    ...
    protected String validacionesPreviasCreate(MtrTipoDocumento bean) throws Exception {
        String msg = null;
        MtrTipoDocumento validar = null;
        return msg;
    }

    protected String validacionesPreviasSave(MtrTipoDocumento bean) throws Exception {
        String msg = null;
        MtrTipoDocumento validar = null;
        return msg;
    }

    protected MtrTipoDocumento completarDatosBean(MtrTipoDocumento bean) throws Exception {
        BigDecimal data = new BigDecimal(0.00);
        bean = this.setCompletarDatosBean(bean);
        return bean;
    }

    protected MtrTipoDocumento setCompletarDatosBean(MtrTipoDocumento bean) throws Exception {
        return bean;
    }

    protected final MtrTipoDocumento setAbstractCreate(MtrTipoDocumento dto) throws Exception {
        MtrTipoDocumento bean = new MtrTipoDocumento();
        bean = (MtrTipoDocumento) BeanUtils.cloneBean(dto);
        return bean;
    }
    ...
    protected MtrTipoDocumento setUploadExcel(Cell currentCell, MtrTipoDocumento mtrTipoDocumento, int contador) throws Exception {
        ...
        case 1:
            try {
                ...
                mtrTipoDocumento.setDescripcion(valorCadena);
            } catch (Exception e) {
        ...
        case 2:
            try {
                ...
                mtrTipoDocumento.setStatus(valorCadena);
            } catch (Exception e) {
    ...
    protected MtrTipoDocumento setInicializarBeanUpdateExcel() {
        MtrTipoDocumento bean = new MtrTipoDocumento();
        bean.setId(null);
        return bean;
    }

    protected final Long setObtenerId(MtrTipoDocumento bean) {
        return bean.getId();
    }
    ...
    protected final BeanCargaMasivoDTO<MtrTipoDocumento> createInstanceMasivoDTO() {
        BeanCargaMasivoDTO<MtrTipoDocumento> beanCargaMasivoDTO = new BeanCargaMasivoDTO<MtrTipoDocumento>();
        return beanCargaMasivoDTO;

    }

    protected final BeanListaMasivoDTO<BeanCargaMasivoDTO<MtrTipoDocumento>> createInstanceListaMasivoDTO() {
        BeanListaMasivoDTO<BeanCargaMasivoDTO<MtrTipoDocumento>> beanCargaMasivoDTOBeanListaMasivoDTO = new BeanListaMasivoDTO<BeanCargaMasivoDTO<MtrTipoDocumento>>();
    ...
    protected int setAbstractDownloadExcel(MtrTipoDocumento bean, HSSFRow dataRow) {
        int contador = 0;
    ...
    protected int setAbstractDownloadExcelSXLSX(MtrTipoDocumento bean, Row dataRow, List<CellStyle> cellStyleList) {
        int contador = 0;
    ...
    protected String setAbstractGenerateInsertExcelSXLSX(MtrTipoDocumento bean) {
        String fechaS = "";
        String sqlInsert = "INSERT INTO MTR_TIPO_DOCUMENTO(";
