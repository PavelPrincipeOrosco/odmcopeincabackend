...
/**
 * Simple Interface for CsOrdenServicioActividad para Carga Masiva.
 */
public interface CsOrdenServicioActividadRequireNewService extends JPACustomRequiredNewService<CsOrdenServicioActividad> {
