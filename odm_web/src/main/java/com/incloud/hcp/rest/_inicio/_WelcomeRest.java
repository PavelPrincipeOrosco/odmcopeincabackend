...
import com.incloud.hcp.OdmApplication;
...
public class _WelcomeRest extends BaseRest{
    ...
    @RequestMapping(value = "/fecha01", method = GET, produces = APPLICATION_JSON_VALUE)
    public ResponseEntity<String> fecha() throws URISyntaxException {
     ...
     * Invocacion Rest al BackEnd
     */
    @ApiOperation(value = "Obtiene fecha Actual v02", produces = "application/json")
    @RequestMapping(value = "/fecha02", method = GET, produces = APPLICATION_JSON_VALUE)
    public ResponseEntity<String> fecha02() throws URISyntaxException {
        log.debug("Find by welcome");
        try {
